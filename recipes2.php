...
<html>
<head>
<title>Summer delicious recipes</title>
...
<div class="container-fluid">
				...
				<ul style="color:#ffffff">
	               ...
	               <li class="has-sub active"><a class="dropdown-toggle" data-toggle="dropdown"  href="recipes.php"><span class="glyphicon glyphicon-cutlery"></span> RECIPES</a>
				      <ul>
		                ...
		                <li class="has-sub active"><a href="recipes2.php">Summer Delicious recipes</a></li>
  ...
  <div class="row" >
     ...
     <div class="col-md-6 col-lg-6" style="font-size:36px;font-weight:bold;color:#2B0000;padding:10px;border-bottom:dotted;line-length:10px;text-align:center"><span class="glyphicon glyphicon-cutlery"></span> SUMMER DELICIOUS RECIPES <span class="glyphicon glyphicon-cutlery"></span></div>
     <div class="col-md-3 col-lg-3"></div>
  </div>
  
  <div class="row">
    <div class="col-md-2 col-lg-2"></div>
	<div class="col-md-4 col-lg-4"><span class="glyphicon  glyphicon-cutlery" style="font-size:17px;color:#2B0000;padding:20px;font-weight:bold">CHEESY SWEET POTATO WEDGES</span>
	     <div class="row" style="background-image:url(images/cheesy-sweet-potato-wedges-105026-1.jpeg);border:groove #400000 5px;border-radius:40px 0px 40px 0px;background-size:100% 100%;padding:155px"></div>
		 <div class="row" style="font-family:'Cooper Black';color:#400000;font-weight:bold;font-size:16px;margin-top:10px;margin-bottom:20px;border:dotted 1px;text-align:center"> 
		    <div class="col-md-6 col-lg-6"> <span class="glyphicon glyphicon-dashboard"></span> Prep time : 1 hour.</div>
			<div class="col-md-6 col-lg-6"><span class="glyphicon glyphicon-cutlery"></span> Servings : 6 </div>
		 </div>	
	   </div>
	...
	<div class="col-md-3 col-lg-3">
	    <div class="row">
		    <div class="col-md-12 col-lg-12" style="padding:20px">
			   ...
			   <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">6 small (400g) orange sweet potatoes, peeled.</span></p>
               <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">1-1/2 tablespoons extra olive oil.</span></p>
               <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">1 teaspoon paprika.</span></p>
               <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">2 teaspoons ground cumin.</span></p>
               <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">1/2 teaspoon sea salt.</span></p>
               <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">300g can red kidney beans,drained,rinsed.</span></p>
               <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">1-1/2 cups smoked cheddar,grated.</span></p>
			   <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">1/4 cup fresh coriander,chopped.</span></p>
			</div>
		</div>
	</div>
	<div class="col-md-2 col-lg-2"></div>
...
Preheat oven to 220C/200C fan-forced.Line a large baking tray with baking paper.</p>
<p style="font-size:14px;color:#743A3A;font-weight:bold"><span style="color:#2B0000">•	Step 2</span>
Cut each sweet potato in half lengthways.Cut into wedges.<p>
<p style="font-size:14px;color:#743A3A;font-weight:bold"><span style="color:#2B0000">•	Step 3</span>
Cook wedges, in batches, in a large saucepan of boiling water for 4 minutes. Drain well.Pat dry with paper towel to remove any excess moisture.Place in a large bowl.Drizzle with oil. Toss to coat. Sprinkle with paprika, cumin and sea salt. Toss to coat.Transfer to prepared tray, arranging wedges in a single layer.</p>
<p style="font-size:14px;color:#743A3A;font-weight:bold"><span style="color:#2B0000">•	Step 4</span>
Roast for 25 minutes, turning during cooking, or until golden and tender. Sprinkle with beans and cheddar.Cook for a further 15 minutes or until cheese is melted and starts to brown. Serve sprinkled with coriander.</p>
...
<tr><td class="col-md-12 col-lg-12"><input type="submit"  required name="re3" value="Comment" style="margin-top:20px"></td></tr>
</table>
                  </form>
				</div>
                 <form method="post">
	            <span class="glyphicon glyphicon-star" style="color:#FFFF00"></span> <input class="btn btn-default" type="submit" name="r3" value="Rate the recipe" style="background:#996666;font-size:16px;font-weight:bolder"> <span class="glyphicon glyphicon-star" style="color:#FFFF00"></span></form>
            </div>
...
$q="INSERT INTO review (email,comment,image,r_name) VALUES ('$email','$comment','$d','r3') ";
mysqli_query($c,$q);

}
$sql="SELECT * FROM review where r_name='r3'";
...
?>
   ...
   <div class="row" style="">
    <div class="col-md-2 col-lg-2"></div>
	<div class="col-md-4 col-lg-4"><span class="glyphicon  glyphicon-cutlery" style="font-size:17px;color:#2B0000;padding:20px;font-weight:bold">SAUSAGE ROLLS</span>
	     <div class="row" style="background-image:url(images/best-ever-homemade-sausage-rolls-98809-1.jpeg);border:groove #400000 5px;border-radius:40px 0px 40px 0px;background-size:100% 100%;padding:230px"></div>
		 <div class="row" style="font-family:'Cooper Black';color:#400000;font-weight:bold;font-size:16px;margin-top:10px;margin-bottom:20px;border:dotted 1px;text-align:center"> 
		    <div class="col-md-6 col-lg-6"> <span class="glyphicon glyphicon-dashboard"></span> Prep time :45 min.</div>
	...
	<div class="col-md-3 col-lg-3">
	    <div class="row">
	      <div class="col-md-12 col-lg-12" style="padding:20px">
			   <p style="color:#2B0000;font-size:17px;font-weight:bold">Ingredients:</p>
			   <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">4 sheets ready rolled puff pastry.</span></p>
               <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">1 tablespoon milk.</span></p>
               <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">1 egg.</span></p>
               <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">500g veal mince, or beef mince.</span></p>
               <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">500g sausage mince</span></p>
               <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">1 small brown onion, finely chopped</span></p>
			   <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">1 small red onion, finely chopped</span></p>
			   <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">1 medium carrot, coarsely grated</span></p>			   
			   <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">3 cloves garlic, crushed</span></p>
			   <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">1/4 cup finely chopped fresh flat-leaf parsley</span></p>
  ...
  <div class="row" >
	...
	<div class="col-md-8 col-lg-8">
	   <p style="color:#2B0000;font-size:17px;font-weight:bold">Method of preparation:</p>
	   <p style="font-size:14px;color:#743A3A;font-weight:bold"><span style="color:#2B0000">•	Step 1</span>Preheat oven to 220C/200C fan-forced. Line 2 large baking trays with baking paper.</p>
<p style="font-size:14px;color:#743A3A;font-weight:bold"><span style="color:#2B0000">•	Step 2</span>
Thaw puff pastry. Meanwhile, combine milk and egg in a small jug. Whisk well. Combine veal mince, sausage mince, onion, carrot, garlic, parsley and sauces in a large bowl. Season with salt and pepper. Divide mixture into 8.</p>
<p style="font-size:14px;color:#743A3A;font-weight:bold"><span style="color:#2B0000">•	Step 3</span>
Lay a sheet of pastry on a flat surface. Cut sheet in half horizontally. Spoon 1/8 of the mince mixture down along the long side of one pastry half, shaping mince into a long sausage shape. Brush opposite long edge with a little egg mixture.</p>
<p style="font-size:14px;color:#743A3A;font-weight:bold"><span style="color:#2B0000">•	Step 4</span>
Roll up pastry to enclose filling, finishing seam side down. Brush top of log with egg mixture. Cut into 6 short pieces. Place pieces, seam side down on prepared tray, 2cm apart. Repeat with remaining mince mixture, pastry and eggwash.</p>
<p style="font-size:14px;color:#743A3A;font-weight:bold"><span style="color:#2B0000">•	Step 5</span>
Bake for 25-30 minutes or until golden and cooked through.</p>
...
<tr><td class="col-md-12 col-lg-12" style="font-family:Berlin Sans FB;color:#2B0000;font-size:20px;background:transparent">Comment: </td></tr>
<tr><td class="col-md-12 col-lg-12"><textarea name="comment" required rows="10" cols="40"></textarea></td></tr>
<tr><td class="col-md-12 col-lg-12"><input type="submit"  required name="re4" value="Comment" style="margin-top:20px"></td></tr>
</table>
</form></div><form method="post">
	  <span class="glyphicon glyphicon-star" style="color:#FFFF00"></span> <input class="btn btn-default" type="submit" name="r4" value="Rate the recipe" style="background:#996666;font-size:16px;font-weight:bolder"> <span class="glyphicon glyphicon-star" style="color:#FFFF00"></span></form>
    </div>
<div class="col-md-6 col-lg-6" style="text-align:center;font-family:Berlin Sans FB;color:#000099;font-size:20px;text-decoration:underline;margin-bottom:30px"> User Reviews

<?php
$c=mysqli_connect('localhost','root',"",'cook');
if(isset($_REQUEST['re4']))
{
$d=$_FILES["a"]["name"];
$_FILES["a"]["size"];
$e=$_FILES["a"]["tmp_name"];
...
$email=$_POST['email'];
$comment=$_POST['comment'];
$q="INSERT INTO review (email,comment,image,r_name) VALUES ('$email','$comment','$d','r4') ";
mysqli_query($c,$q);

}
$sql="SELECT * FROM review where r_name='r4'";
$getquery= mysqli_query($c,$sql);
while($s= mysqli_fetch_array($getquery))
{
$email=$s['email'];
...
?></div></div></div>
  ...
  <div class="row">
      <div class="col-md-12 col-lg-12">
	   <ul class="pager">
  <li><a href="recipes.php" style="font-weight:bold;color:#FFFFFF;background-color:#000033" id="zoom">Previous</a></li>
   <li><a href="recipes3.php" style="font-weight:bold;color:#FFFFFF;background-color:#000033" id="large">Next</a></li>
  </ul>		
