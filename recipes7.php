...
session_start();
if(isset($_REQUEST['r13']))
{

 $_SESSION['r']="r13";
header('location:rating.php'); 
}
if(isset($_REQUEST['r14']))
{
...
<html>
<head>
<title>Veggie Soup recipes</title>
...
<div class="container-fluid" >
				  ...
				  <ul style="color:#ffffff">
	                ...
	                <li class="has-sub active"><a class="dropdown-toggle" data-toggle="dropdown"  href="recipes.php"><span class="glyphicon glyphicon-cutlery"></span> RECIPES</a>
		               <ul>
						 ...
						 <li class="has-sub active"><a href="recipes7.php">Veggie Soup recipes</a></li>
					  </ul>
			      </li>
 ...
 <div id="myModal" class="modal">
  ...
  <div class="row">
     ...
     <div class="col-md-8 col-lg-8" style="font-size:36px;font-weight:bold;color:#2B0000;padding:10px;border-bottom:dotted;line-length:10px;text-align:center"><span class="glyphicon glyphicon-cutlery"></span>VEGGIE SOUP RECIPES<span class="glyphicon glyphicon-cutlery"></span></div>
     <div class="col-md-2 col-lg-2"></div>
  </div>
  
  <div class="row">
    <div class="col-md-2 col-lg-2"></div>
	<div class="col-md-4 col-lg-4"><span class="glyphicon  glyphicon-cutlery" style="font-size:17px;color:#2B0000;padding:20px;font-weight:bold">AUTUMN TOMATAO AND VEGETABLE SOUP</span>
	     <div class="row" style="background-image:url(images/autumn-tomato-and-vegetable-soup-84090-1.jpeg);border:groove #400000 5px;border-radius:40px 0px 40px 0px;background-size:100% 100%;padding:140px"></div>
		 <div class="row" style="font-family:'Cooper Black';color:#400000;font-weight:bold;font-size:16px;margin-top:10px;margin-bottom:20px;border:dotted 1px;text-align:center"> 
		    <div class="col-md-6 col-lg-6"> <span class="glyphicon glyphicon-dashboard"></span> Prep time : 40 min.</div>
	...
	<div class="col-md-3 col-lg-3">
	    <div class="row">
		    <div class="col-md-12 col-lg-12" style="padding:20px">
			   ...
			   <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">1 tablespoon olive oil.</span></p>
               <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">1 medium brown onion, chopped.</span></p>
               <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">2 garlic cloves, crushed.</span></p>
                <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">1 large red capsicum, chopped.</span></p>
               <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">1 litre salt-reduced chicken stock.</span></p>
			   <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">575g jar napoletana pasta sauce.</span></p>
			   <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">1 cup dried small shell pasta.</span></p>
			   <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">1/2 cup frozen peas.</span></p>
			   <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">80g baby spinach.</span></p>
			  	</div>
		</div>
	</div>
	<div class="col-md-2 col-lg-2"></div>
...
Heat oil in a large saucepan over medium-high heat. Add onion, garlic and celery. Cook, stirring, for 3 to 5 minutes or until onion has softened. Add zucchini and capsicum. Cook, stirring occasionally, for 4 to 5 minutes or until vegetables start to soften.</p>
<p style="font-size:14px;color:#743A3A;font-weight:bold"><span style="color:#2B0000">•	Step 2</span>
Add stock, sauce and 2 cups cold water. Cover. Bring to the boil. Reduce heat to low. Simmer for 10 minutes or until vegetables are just tender. Add pasta and peas. Simmer, uncovered, for 10 minutes or until pasta is just tender. Stir in spinach. Serve topped with parmesan.<p>
                  ...
                  <div class="col-md-12 col-lg-12"  style="font-family:Berlin Sans FB;color:#2B0000;font-size:20px;background:transparent">Select image:</div>
                     <div class="col-md-12 col-lg-12"><input type="file" name="a" style="font-size:10px;padding-bottom:10px"/></div>
                       ...
                       <table >
                         ...
                         <tr><td class="col-md-12 col-lg-12"><input type="submit"  required name="re13" value="Comment" style="margin-top:20px"></td></tr>
                       </table>
                </form>
			  </div>
                <form method="post">
	              <span class="glyphicon glyphicon-star" style="color:#FFFF00"></span> <input class="btn btn-default" type="submit" name="r13" value="Rate the recipe" style="background:#996666;font-size:16px;font-weight:bolder"> <span class="glyphicon glyphicon-star" style="color:#FFFF00"></span></form>
          </div>
...
$q="INSERT INTO review (email,comment,image,r_name) VALUES ('$email','$comment','$d','r13') ";
mysqli_query($c,$q);

}
$sql="SELECT * FROM review where r_name='r13'";
...
?></div>
   ...
   <div class="row">
     <div class="col-md-2 col-lg-2"></div>
	 <div class="col-md-4 col-lg-4"><span class="glyphicon  glyphicon-cutlery" style="font-size:17px;color:#2B0000;padding:20px;font-weight:bold">CHICKEN-NOODLE VEGGIE SOUP</span>
	   <div class="row">
	     <div class="col-md-12 col-lg-12" style="background-image:url(images/chicken-vegetable-and-noodle-soup-61147-1.jpeg);border:groove #400000 5px;border-radius:40px 0px 40px 0px;background-size:100% 100%;padding:140px"></div>
	...
	<div class="col-md-3 col-lg-3">
	    <div class="row">
		    <div class="col-md-12 col-lg-12" style="padding:20px">
			   <p style="color:#2B0000;font-size:17px;font-weight:bold">Ingredients:</p>
			   <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">20g butter.</span></p>
               <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">1 brown onion, chopped.</span></p>
               <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">3 large carrots, peeled, finely diced.</span></p>
               <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">3 celery stalks, finely diced.</span></p>
               <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">1 quantity chicken stock with chopped chicken.</span></p>
               <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">60g dried vermicelli egg pasta.</span></p>
			</div>
		</div>
	</div>
	<div class="col-md-2 col-lg-2"></div>
  ...
  <div class="row" >
	...
	<div class="col-md-8 col-lg-8">
	   <p style="color:#2B0000;font-size:17px;font-weight:bold">Method of preparation:</p>
	   <p style="font-size:14px;color:#743A3A;font-weight:bold"><span style="color:#2B0000">•	Step 1</span>
	  Melt butter in large saucepan over medium-high heat. Add onion, carrot and celery. Cook, stirring occasionally, for 10 minutes or until onion has softened. Add 2 litres stock and 2 cups cold water. Cover. Bring to the boil.</p>
       <p style="font-size:14px;color:#743A3A;font-weight:bold"><span style="color:#2B0000">•	Step 2</span>       
Reduce heat to medium. Add pasta and 4 cups chopped chicken. Simmer, stirring occasionally, for 10 minutes or until pasta is tender. Season with salt and pepper. Serve sprinkled with chives.<p>
...
<tr><td class="col-md-12 col-lg-12" style="font-family:Berlin Sans FB;color:#2B0000;font-size:20px;background:transparent">Comment: </td></tr>
<tr><td class="col-md-12 col-lg-12"><textarea name="comment" required rows="10" cols="40"></textarea></td></tr>
<tr><td class="col-md-12 col-lg-12"><input type="submit"  required name="re14" value="Comment" style="margin-top:20px"></td></tr>
</table>
                 </form>
			  </div>
                 <form method="post">
	             <span class="glyphicon glyphicon-star" style="color:#FFFF00"></span> <input class="btn btn-default" type="submit" name="r14" value="Rate the recipe" style="background:#996666;font-size:16px;font-weight:bolder">  <span class="glyphicon glyphicon-star" style="color:#FFFF00"></span></form>
            </div>
          <div class="col-md-6 col-lg-6" style="text-align:center;font-family:Berlin Sans FB;color:#000099;font-size:20px;text-decoration:underline;margin-bottom:30px"> User Reviews

<?php
$c=mysqli_connect('localhost','root',"",'cook');
if(isset($_REQUEST['re14']))
{
$d=$_FILES["a"]["name"];
$_FILES["a"]["size"];
$e=$_FILES["a"]["tmp_name"];
...
$email=$_POST['email'];
$comment=$_POST['comment'];
$q="INSERT INTO review (email,comment,image,r_name) VALUES ('$email','$comment','$d','r14') ";
mysqli_query($c,$q);

}
$sql="SELECT * FROM review where r_name='r14'";
$getquery= mysqli_query($c,$sql);
while($s= mysqli_fetch_array($getquery))
{
$email=$s['email'];
