...
session_start();
if(isset($_REQUEST['r9']))
{

 $_SESSION['r']="r9";
header('location:rating.php'); 
}
if(isset($_REQUEST['r10']))
{
...
<html>
<head>
<title>Vegeterian Curry recipes</title>
...
<div class="container-fluid">
    ...
    <div class="wrap-body wrap-header col-md-11 col-lg-11" >
	 ...
	 <li class="has-sub active"><a class="dropdown-toggle" data-toggle="dropdown"  href="recipes.php"><span class="glyphicon glyphicon-cutlery"></span> RECIPES</a>
		...
		<li class="has-sub active"><a href="recpies5.php">Vegetarian Curry recipes</a></li>
  ...
  <div class="col-md-8 col-lg-8" style="font-size:36px;font-weight:bold;color:#2B0000;padding:10px;border-bottom:dotted;line-length:10px;text-align:center"><span class="glyphicon glyphicon-cutlery"></span> VEGETARIAN CURRY RECIPES <span class="glyphicon glyphicon-cutlery"></span></div>
  <div class="col-md-2 col-lg-2"></div>
  </div>
  <div class="row" style="">
    <div class="col-md-2 col-lg-2"></div>
	<div class="col-md-4 col-lg-4"><span class="glyphicon  glyphicon-cutlery" style="font-size:17px;color:#2B0000;padding:20px;font-weight:bold">MASALA EGG CURRY</span>
	   <div class="row">
	     <div class="col-md-12 col-lg-12" style="background-image:url(images/masala-egg-curry-105708-1.jpeg);border:groove #400000 5px;border-radius:40px 0px 40px 0px;background-size:100% 100%;padding:200px"></div>
		 <div class="col-md-12 col-lg-12" style="font-family:'Cooper Black';color:#400000;font-weight:bold;font-size:16px;margin-top:10px;margin-bottom:20px;border:dotted 1px;text-align:center"> 
		    <div class="col-md-6 col-lg-6"> <span class="glyphicon glyphicon-dashboard"></span> Prep time : 25 min.</div>
	...
	<div class="col-md-3 col-lg-3">
	    <div class="row">
		    <div class="col-md-12 col-lg-12" style="padding:20px">
			   ...
			   <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">6 eggs, at room temperature.</span></p>
               <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">2 tablespoons vegetable oil.</span></p>
               <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">1 large red onion, halved, thinly sliced.</span></p>
               <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">1/2 teaspoon ground turmeric.</span></p>
               <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">1/2 teaspoon chilli powder.</span></p>
               <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">4cm piece fresh ginger, finely grated.</span></p>
               <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">1 long green chilli, thinly sliced.</span></p>
			   <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">270ml can coconut milk</span></p>
			   <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">150g green beans, trimmed</span></p>
			   <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">1/2 teaspoon garam masala, toasted</span></p>
			   <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">Steamed basmati rice, to serve</span></p>
			</div>
		</div>
	</div>
	<div class="col-md-2 col-lg-2"></div>
...
Place eggs in a saucepan. Cover with cold water. Bring to the boil over high heat, stirring occasionally. Reduce heat to medium. Simmer for 3 minutes. Remove pan from heat. Carefully, transfer eggs to a board. Set aside to cool slightly.</p>
<p style="font-size:14px;color:#743A3A;font-weight:bold"><span style="color:#2B0000">•	Step 2</span>
Meanwhile, heat oil in large saucepan over medium heat. Cook onion, stirring, for 7 minutes or until light golden. Add turmeric, chilli powder, ginger and 1/2 the green chilli. Cook, stirring, for 1 minute or until fragrant.<p>
<p style="font-size:14px;color:#743A3A;font-weight:bold"><span style="color:#2B0000">•	Step 3</span>
Add coconut milk and 1/2 cup water. Bring to the boil. Reduce heat to low. Simmer for 5 minutes or until liquid reduces by half.</p>
<p style="font-size:14px;color:#743A3A;font-weight:bold"><span style="color:#2B0000">•	Step 4</span>
Peel eggs.Add beans, peas and eggs to curry. Cook,stirring,for 1 to 2 minutes or until beans are just tender and eggs are heated through. Cut eggs in half.Sprinkle curry with garam masala, coriander and remaining chilli and serve with rice.</p>
...
<tr><td class="col-md-12 col-lg-12"><input type="submit"  required name="re9" value="Comment" style="margin-top:20px"></td></tr>
</table>
</form></div>
<form method="post">
	 <span class="glyphicon glyphicon-star" style="color:#FFFF00"></span><input class="btn btn-default" type="submit" name="r9" value="Rate the recipe" style="background:#996666;font-size:16px;font-weight:bolder">  <span class="glyphicon glyphicon-star" style="color:#FFFF00"></span></form>
...
$q="INSERT INTO review (email,comment,image,r_name) VALUES ('$email','$comment','$d','r9') ";
mysqli_query($c,$q);

}
$sql="SELECT * FROM review where r_name='r9'";
...
echo  " <div class='col-md-10 col-lg-10'>";
   echo  " <div class='col-md-4 col-lg-4' style='float:left;margin-top:20px'>";
...
?></div></div></div>
   ...
   <div class="row" style="">
    <div class="col-md-2 col-lg-2"></div>
	<div class="col-md-4 col-lg-4"><span class="glyphicon  glyphicon-cutlery" style="font-size:17px;color:#2B0000;padding:20px;font-weight:bold">POTATO CURRY WITH CHAPAATI</span>
	   <div class="row">
	     <div class="col-md-12 col-lg-12" style="background-image:url(images/potato-curry-with-roti-101092-1.jpeg);border:groove #400000 5px;border-radius:40px 0px 40px 0px;background-size:100% 100%;padding:210px"></div>
		 <div class="col-md-12 col-lg-12" style="font-family:'Cooper Black';color:#400000;font-weight:bold;font-size:16px;margin-top:10px;margin-bottom:20px;border:dotted 1px;text-align:center"> 
	...
	<div class="col-md-3 col-lg-3">
	    <div class="row">
		    <div class="col-md-12 col-lg-12" style="padding:20px">
			   <p style="color:#2B0000;font-size:17px;font-weight:bold">Ingredients:</p>
			   <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">600g desired potatoes,peeled,cut into 1cm-thick slices.</span></p>
               <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">1 tablespoon vegetable oil.</span></p>
               <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">1 red onion, thinly sliced.</span></p>
               <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">2 garlic cloves, thinly sliced.</span></p>
               <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">6cm piece fresh ginger, finely grated.</span></p>
               <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">1 teaspoon cumin seeds.</span></p>
			   <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">2 teaspoons ground coriander.</span></p>
			   <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">1/2 teaspoon ground turmeric.</span></p>
			   <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">1/2 cup fresh coriander sprigs.</span></p>
			   <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">Mango chilli chutney, to serve.</span></p>
			   <p><span class="glyphicon glyphicon-paperclip" style="font-size:19px;color:#743A3A">4 chapaatis.</span></p>
			</div>
		</div>
	</div>
	<div class="col-md-2 col-lg-2"></div>
  ...
  <div class="row" style=";padding:20px">
	...
	<div class="col-md-8 col-lg-8">
	   <p style="color:#2B0000;font-size:17px;font-weight:bold">Method of preparation:</p>
	   <p style="font-size:14px;color:#743A3A;font-weight:bold"><span style="color:#2B0000">•	Step 1</span>
	   Cook potato in a large saucepan of boiling salted water for 2 to 3 minutes or until just tender. Drain</p>
       <p style="font-size:14px;color:#743A3A;font-weight:bold"><span style="color:#2B0000">•	Step 2</span>
       Heat oil in a large frying pan over high heat. Add onion, garlic and ginger. Cook, stirring, for 3 minutes or until softened. Stir in seeds, ground coriander and turmeric. Cook,stirring, for 1 minute or until fragrant<p>
       <p style="font-size:14px;color:#743A3A;font-weight:bold"><span style="color:#2B0000">•	Step 3</span>
       Add potato and 1/2 cup cold water. Cook for 2 to 3 minutes or until potato is tender and water has evaporated.</p>
       <p style="font-size:14px;color:#743A3A;font-weight:bold"><span style="color:#2B0000">•	Step 4</span>
       Meanwhile, heat roti following packet directions.Place chapaatis on serving plates. Cover half of each roti with potato filling. Dollop with yoghurt and top with coriander. Fold roti over to cover filling.Serve with chutney and sprinkled with extra coriander.</p>
   <div class="row" style="border:dotted 1px">;
<div class="row" style="font-size:20px;font:color:#000033;font-weight:bold;font-family:'Cooper Black'"><center>Give Reviews</center></div>
<div class="row" style="padding:20px">
    <div class="col-md-6 col-lg-6"  >
...
<tr><td class="col-md-12 col-lg-12" style="font-family:Berlin Sans FB;color:#2B0000;font-size:20px;background:transparent">Comment: </td></tr>
<tr><td class="col-md-12 col-lg-12"><textarea name="comment" required rows="10" cols="50"></textarea></td></tr>
<tr><td class="col-md-12 col-lg-12"><input type="submit"  required name="re10" value="Comment" style="margin-top:20px"></td></tr>
</table>
</form></div>
<form method="post">
	 <span class="glyphicon glyphicon-star" style="color:#FFFF00"></span><input class="btn btn-default" type="submit" name="r10" value="Rate the recipe" style="background:#996666;font-size:16px;font-weight:bolder">  <span class="glyphicon glyphicon-star" style="color:#FFFF00"></span></form>
...
$email=$_POST['email'];
$comment=$_POST['comment'];
$q="INSERT INTO review (email,comment,image,r_name) VALUES ('$email','$comment','$d','r10') ";
mysqli_query($c,$q);

}
$sql="SELECT * FROM review where r_name='r10'";
$getquery= mysqli_query($c,$sql);
while($s= mysqli_fetch_array($getquery))
{
$email=$s['email'];
...
?>
  ...
  <ul class="pager">
    <li><a href="recipes4.php"  style="font-weight:bold;color:#FFFFFF;background-color:#000033" id="zoom">Previous</a></li>
    <li><a href="recipes6.php"  style="font-weight:bold;color:#FFFFFF;background-color:#000033" id="large">Next</a></li>
</ul>		
